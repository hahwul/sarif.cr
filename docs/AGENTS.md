# AGENTS.md - AI Agent Instructions for the sarif.cr Documentation Site

This document is for AI agents editing the sarif.cr documentation site under `docs/`.

## Project Overview

This is the documentation companion to [sarif.cr](https://github.com/hahwul/sarif.cr), a Crystal implementation of the SARIF 2.1.0 specification. The site is a static site built with [Hwaro](https://github.com/hahwul/hwaro) (Crinja/Jinja2 templates).
...
- Use **camelCase** when referring to SARIF JSON keys and **snake_case** for Crystal properties.
- Use tables for property/parameter documentation in the API reference.
- No emojis in content.
- Code samples must be valid Crystal with realistic SARIF usage that matches the actual API in `src/`.
...
3. **Validate TOML syntax** in config.toml after edits.
